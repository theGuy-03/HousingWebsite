...
@section('user')
<div class="card-body">
    <form action="{{  route('update.userPassword') }}" method="POST">
        @csrf
            ...
            <div class="row mb-3">
                <div class="col-2 ">
                    <label for="newPassword" class="col-form-label">Old Password</label>
                </div>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <div class="col-2 ">
                    <label for="confitm_Password" class="col-form-label">Old Password</label>
                </div>
                <div class="col-sm-10">
