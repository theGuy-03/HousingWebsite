...
<div class="card card-profile sidenav bg-white navbar navbar-vertical navbar-expand-lg border-0 border-radius-xl my-3 fixed-start ms-4 width:300x" >
    ...
    <div class="row justify-content-center">
        <div class="col-4 col-lg-4 order-lg-2">
            ...
            <a href="#">
                <img src="{{!empty($userData->profile?->profile_image)? url($userData->profile?->profile_image):url('upload/avatar.png') }}"  style="height: 90px;width :90px ;border-radius:50%">
            </a>
    ...
    <div class="card-header text-center border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
        <div class="d-flex justify-content-between">
            <a href="{{ route('user.about') }}" class="btn btn-sm btn-info mb-0 d-none d-lg-block " style="margin: 2px"><i class=" ri-information-fill"></i> About</a>
            <a href="/chatify/" class="btn btn-sm btn-dark float-right mb-0 d-none d-lg-block" style="margin: 2px"><i class="ri-messenger-fill"></i> Message</a>
        </div>
    </div>
</div>
