...
@section('user')
@php
    $id=Auth::user()->where('usertype','admin')->id;
      ...
      <div class="row justify-content-center">
        <div class="col-4 col-lg-4 order-lg-2">
          <div class="mt-n4 mt-lg-n6 mb-4 mb-lg-0">
              ...
              <img src="{{ asset('frontend/profile/img/team-2.jpg') }}" class="rounded-circle img-fluid  border-2 border-white">
      ...
      <div class="card-body pt-0">
        ...
        <div class="text-center mt-4">
          ...
          <div class="h6 font-weight-300">
            <i class="ni location_pin mr-2"></i>{{ $userData?->address }}
          </div>
          <div class="h6 mt-4">
